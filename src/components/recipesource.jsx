    ...
    return (
        ...
        <div className="meal">
            ...
            <section className="recipe-source-container">
                <div className="recipe-source" onClick={() => setNewRecipeSource('suggester')}>
                        <GiHotMeal className="recipe-source-icon"/>
                        <p className='prevent-select'>Recipe suggester</p>
                </div>
                <div className="recipe-source" onClick={() => setNewRecipeSource('favourites')}>
                        <FaHeart className="recipe-source-icon"/>
                        <p className='prevent-select'>Favourites</p>
                </div>
            </section>
        </div>
        <button className='btn' onClick={() => setShowNewMeal(false)}>Back</button>
        </>
    )
}